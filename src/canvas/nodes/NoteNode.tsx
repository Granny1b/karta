...
function NoteNodeView({ data, selected, dragging }: NodeProps<NoteFlowNode>): JSX.Element {
  ...
  // Outside the sticky, which clips its overflow: half of every handle hangs
  // over the edge it resizes.
  const resizer = <NodeResize node={note} selected={selected === true} />;
