    ...
    <div ref={root} className="relative flex items-center">
      ...
      {open ? (
        <div
          ...
          className="absolute bottom-full left-1/2 mb-2 w-[176px] -translate-x-1/2 rounded-[var(--radius-md)] border border-line bg-raised p-2 shadow-[shadow:var(--shadow-overlay)]"
        >
